...
DATA_BANK = {
    ...
    "القارات": {
        ...
        "أفريقيا (قسم جنوبي) 🦁": ["أنغولا🇦🇴", "بنين🇧🇯", "بوتسوانا🇧🇼", "بوروندي🇧🇮", "الرأس الأخضر🇨🇻", "الكاميرون🇨🇲", "جمهورية أفريقيا الوسطى🇨🇫", "جزر القمر🇰🇲", "الكونغو🇨🇬", "جمهورية الكونغو الديمقراطية🇨🇩", "غينيا الاستوائية🇬🇶", "إريتريا🇪🇷", "إسواتيني🇸🇿", "إثيوبيا🇪🇹", "الغابون🇬🇦", "غامبيا🇬مم", "غانا🇬🇭", "غينيا🇬🇳", "غينيا بيساو🇬🇼", "ساحل العاج🇨🇮", "كينيا🇰🇪", "ليسوتو🇱🇸", "ليبيريا🇱🇷", "مدغشقر🇲🇬", "مالاوي🇲🇼", "موريشيوس🇲🇺", "موزمبيق🇲🇿", "ناميبيا🇳🇦"],
...
# دالة السيرفر الوهمي للرد على المنصات السحابية كـ Health Check
...
if __name__ == '__main__':
    # تشغيل السيرفر الوهمي في خيط منفصل بخلفية النظام لحماية البوت من التوقف
    threading.Thread(target=run_dummy_server, daemon=True).start()
    
    # تشغيل استقبال تحديثات البوت بدون توقف
